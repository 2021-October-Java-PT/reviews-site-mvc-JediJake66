...
public class ReviewRepository {
    ...
    public ReviewRepository(){
        Review reviewOne = new Review(1L,"Millenium Falcon","/images/falcon.JPG","As Seen In The Rise Of Skywalker", "This is one of my favorite lego sets. " +
        ...
        Review reviewTwo = new Review(2L,"Y-Wing Starfighter","/images/y-wing2.JPG","As Seen In The Rise Of Skywalker",
        ...
        Review reviewThree = new Review(3L,"The Razor Crest","/images/razorcrest.JPG","As Seen In The Mandalorian","The Razor Crest was an amazing build. " +
        ...
        Review reviewFour = new Review(4L,"Imperial Shuttle","/images/impshuttle.JPG","As Seen In Return Of The Jedi",
        ...
        Review reviewFive = new Review(5L,"First Order Special Forces TIE Fighter","/images/tiefighter.JPG","As Seen In The Force Awakens",
        ...
        Review reviewSix = new Review(6L,"General Grievous's Starfighter","/images/grievship.JPG","As Seen In The Clone Wars Animated Series",
